...
@Component({
  selector: 'app-leads-central',
  templateUrl: './leads-central.component.html',
  styleUrls: ['./leads-central.component.css']
})
export class LeadsCentralComponent implements OnInit {
  user: User;
  username: string;
  teams: string;
  roles: string;
